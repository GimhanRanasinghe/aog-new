...
import { Check, CheckCheck, Clock, Send, File, Paperclip, MessageSquare } from "lucide-react"
        ...
        <Sheet>
          <SheetTrigger asChild>
            <Button variant="outline" size="icon" className="rounded-full">
              ...
              {activeGroup.messages.some((m) => m.status === "sent" && m.senderId !== "current-user") && (
          ...
          <SheetContent className="w-[400px] sm:w-[540px] p-0">
            <SheetHeader className="h-14 border-b bg-background p-4">
              <SheetTitle className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-medium text-left">{activeGroup.name}</h3>
